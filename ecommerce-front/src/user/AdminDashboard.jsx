...
const AdminDashboard = () => {
            ...
            <div className="card">
                ...
                <ul className="list-group">
                    <li className="list-group-item">
                        <Link className="nav-link" to="/create/category">Criar Categoria</Link>
                    </li>
                    <li className="list-group-item">
                        <Link className="nav-link" to="/create/product">Criar Produto!</Link>
                    </li>
                </ul>
            </div>
        )
    ...
    return (
        <Layout title="Painel de Controle do Administrador" description={`Bem vindo ${name}!`}>
